...
const GUIDES = [
  ...
  {
    id: 'activity-log',
    title: 'Activity Log & Auditing',
    icon: LayoutDashboard,
    content: (
      <div className="guide-content">
        <h2 style={{ fontSize: '1.5rem', fontWeight: 700, marginBottom: '1rem' }}>Tracking Organizational Activity</h2>
        <p>The <strong>Activity Log</strong> page acts as your primary audit trail. It automatically records major actions across your Schedulo workspace, providing transparency and accountability.</p>

        <h3>How to Use the Activity Log</h3>
        <p>Navigate to <strong>Activity Log</strong> under the Insights section in the sidebar.</p>
        <ul style={{ paddingLeft: '1.5rem', marginTop: '0.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          <li><strong>Chronological View:</strong> Actions are displayed chronologically, with the most recent at the top.</li>
          <li><strong>Identify Users:</strong> Every log entry clearly marks <em>who</em> performed the action, ensuring full accountability.</li>
          <li><strong>Timetable Events:</strong> When a new timetable is generated by the AI, it is logged here, so administrators know exactly when schedules were locked in.</li>
          <li><strong>Security Audits:</strong> Use this page when investigating unwanted changes. If a user was deleted or a role was modified incorrectly, you will find a footprint here.</li>
        </ul>

        <div style={{ background: 'rgba(79, 142, 247, 0.08)', borderLeft: '4px solid var(--brand-primary)', padding: '1rem', borderRadius: '4px', margin: '1.5rem 0' }}>
          <strong style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}><Info size={18}/> Retention Policy</strong>
          Standard organizations retain 30 days of activity logs. Upgraded tiers hold up to 1 year of audit trails.
        </div>
      </div>
    )
  }
